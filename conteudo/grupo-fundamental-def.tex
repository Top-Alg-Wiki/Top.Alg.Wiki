...
\begin{titlemize}{Lista de dependências}
	\item \hyperref[produto-bem-definido-prop]{Produto de laços};\\ %'dependencia1' é o label onde o conceito Dependência 1 aparece (--à arrumar um padrão para referencias e labels--) 
