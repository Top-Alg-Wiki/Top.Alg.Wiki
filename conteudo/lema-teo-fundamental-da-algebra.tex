...
Note também que a homotopia de $g|_{r\mathbb{S}^1}$ e $f_r^n$ deforma a imagem do polinômio que, restrito a $r\mathbb{S}^1$, torna-se uma curva fechada no plano dos complexos no círculo de raio $r$ em $\mathbb{C}. Veja a imagem abaixo.
\begin{figure}[h]
